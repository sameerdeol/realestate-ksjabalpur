...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?php echo base_url('template'); ?>/assets/css/sameer.css">
    ...
    <link rel="shortcut icon" href="https://cdn.datatables.net/2.2.1/css/dataTables.bootstrap4.css" />
